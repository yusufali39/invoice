...
.container {
  width: 76mm; /* Allow 2mm padding on each side */
  margin: 0 auto;
  padding: 0 !important;
}
...
// In the saveAsPDF function within generateInvoice()
function saveAsPDF() {
  ...
  html2pdf(element, {
    ...
    html2canvas: { 
      scale: 2,
      useCORS: true,
      windowWidth: 80 * 3.78, // Convert 80mm to pixels (1mm ≈ 3.78px)
      width: 80 * 3.78 // Set exact width
    },
    jsPDF: { 
      unit: 'mm',
      format: [80, 297], // Custom size (80mm width, 297mm height)
